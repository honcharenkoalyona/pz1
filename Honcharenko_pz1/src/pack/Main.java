...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        User user1 = new User("Roma", "nick1", 18);
        User user2 = new User("Misha", "nick2", 24);
        User user3 = new User("Alexandra", "nick3", 13);
        ...
        System.out.println("Сравнение одинаковых пользователей: " +
                new User("Roma", "nick1", 18).equals(
                        new User("Roma", "nick1", 18)));
        System.out.println("Сравнение первого и второго пользователя: " +
                user1.equals(
                        user2));

        System.out.println(userList.contains(new User("Misha", "nick2", 24)));
        userList.remove(new User("Misha", "nick2", 24));
        ...
        userList1.add(new User("Roma", "nick1", 18));
        userList2.add(new User("Roma", "nick1", 18));
        userList3.add(new User("Alexandra", "nick3", 13));
